...
export default function Nav() {
  ...
  return (
    ...
    <nav className="mob-px" style={{
      ...
      <Link href="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', marginLeft: theme === 'light' ? '4px' : '0' }}>
        <Image
          src={theme === 'light' ? '/logo-blacklogo.png' : '/logo-transparent.png'}
          alt="Tarvico Inc. — A Private Technology Holding Company"
          width={240}
          height={100}
          style={{ objectFit: 'contain', height: theme === 'light' ? 108 : 66, width: 'auto', transition: 'opacity 0.4s ease' }}
          priority
        />
      </Link>
